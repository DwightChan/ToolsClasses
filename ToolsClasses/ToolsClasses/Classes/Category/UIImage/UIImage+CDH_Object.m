...
#import "UIImage+CDH_Object.h"

@implementation UIImage (CDH_Object)
...
- (UIImage *)cdh_imageResizingWithImage {
    ...
    UIImage *image = [self resizableImageWithCapInsets:UIEdgeInsetsMake(imageH, imageW, imageH, imageW)];
